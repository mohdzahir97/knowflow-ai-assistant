 ...
 * Inline SVG icons.
 *
 * Hand-drawn rather than an icon package: the app needs about twenty glyphs,
 * and inlining them keeps the set consistent in weight, colourable via
 * `currentColor`, and free of another dependency to keep current.
 *
 * All are drawn on a 24-unit grid with a 1.75 stroke so they sit correctly
 * next to 550-weight text at any size.
 */
...
const PATHS: Record<IconName, JSX.Element> = {
  ...
  sparkles: <path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9zM19 3v4M17 5h4" />,
};
...
export function Icon({ name, size = 16, ...rest }: IconProps) {
  return (
    <svg
      ...
      // label or an aria-label, so announcing it again is noise.
      aria-hidden="true"
      focusable="false"
      {...rest}
    >
